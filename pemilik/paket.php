          		...
          		<div class="cd-products-table">
          			...
          			<div class="cd-products-wrapper">
          				<ul class="cd-products-columns">
          					<li class="product">
          						<div class="top-info">
          							<div class="check"></div>
          							<img src="assets/images/basic.JPG" alt="product image">
                        <h4>Produk Saya</h4>
                        <h4>Upgrade</h4>
          						</div> <!-- .top-info -->
          						...
          						<ul class="cd-features-list">
          							...
          							<li>1 Side</li>
          							<li>3 Port</li>
          							<li><a href="#0" class="filter waves-effect waves-light btn green">Ambil</a></li>
          						</ul>
          					</li> <!-- .product -->
          					...
          					<li class="product">
          						<div class="top-info">
          							<div class="check"></div>
          							<img src="assets/images/advance.JPG" alt="product image">
                      ...
                      <h4>Upgrade</h4>
          					...
          					<li class="product">
          						<div class="top-info">
          							<div class="check"></div>
          							<img src="assets/images/pro.JPG" alt="product image">
                        <h4>Produk Saya</h4>
                        <h4>Upgrade</h4>
          						</div> <!-- .top-info -->
