        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="lapangan.php"><i class="material-icons">desktop_windows</i>Lapangan</a></li>
            ...
            <main class="mn-inner">
              <div class="col s12 m6 l4">
                <a class="waves-effect waves-light btn blue m-b-xs col s12 m6 l8" href="input_lap.php">INPUT LAPANGAN</a>
              </div>
              <div class="row">
              ...
              <div class="col s12 m6 l4">
                <div class="card">
                    <div class="card-image">
                      <img src="assets/images/lap.png" alt="">
                          <span class="card-title">Lapangan Satu</span>
                              </div>
                                <div class="card-content">
                                    <h4>HARGA</h4>
                                </div>
                                ...
                                <div class="card-action s12">
                                    <a class="waves-effect waves-light btn red m-b-xs s18">EDIT</a>
                                </div>
                  </div>
                </div>
                <div class="col s12 m6 l4">
                  <div class="card">
                      <div class="card-image">
                        <img src="assets/images/lap.png" alt="">
                            <span class="card-title">Lapangan Dua</span>
                                </div>
                                <div class="card-content">
                                    <h4>HARGA</h4>
                                </div>
                                <div class="card-content">
                                  ...
                                  <div class="card-action">
                                      <a class="waves-effect waves-light btn red m-b-xs">EDIT</a>
                                  </div>
                    </div>
                  </div>
                </div>
