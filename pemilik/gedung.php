...
<html lang="en">
              ...
              <div class="row">
                ...
                <div class="card">
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <form class="col s12" method="post" id="" action="insert_gedung.php">
                                        <div class="row">
                                        ...
                                        <?php
					                                   ...
					                                   $cari=mysqli_query($koneksi,"select max(id_gedung) as maxged from gedungs");
					                                   $data=mysqli_fetch_array($cari);
					                                   $kodeged = $data['maxged'];
					                                   $nourut = (int) substr($kodeged,16,3);
					                                   $nourut++;
					                                   $kar = "$id_pemilik";
					                                   $newID = $kar.sprintf("%03s",$nourut);
                                         ?>
                                        <div class="row">
                                            <div class="input-field col s12">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="file-field input-field col s12">
                                            <button class="waves-effect waves-light btn blue btn-block m36" id="" type="submit"><i class="material-icons left">cloud</i>SUBMIT</button>
                                              </div>
                                            </div>
                                    </form>
                                </div>
	...
	$("#lebokno").click(function(){

		var dataku = $('#isi-gedung').serialize();

		$.ajax({
			type: 'POST',
			url: "insert_gedung.php",
			data: dataku,
