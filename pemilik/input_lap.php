        ...
        <div class="mn-content fixed-sidebar">
            ...
            <main class="mn-inner">
              <div class="row">
                ...
                <div class="card">
                            <div class="card-content">
                                <span class="card-title">Input Lapangan</span><br>
                                <div class="row">
                                    <form class="col s12">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input id="first_name" type="text" class="validate" value="G10203" disabled>
                                                <label for="first_name">G10203</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input id="last_name" type="text" class="validate" placeholder="ID Lapangan">
                                                <label for="last_name">ID Lapangan</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input id="password" type="text" class="validate">
                                                <label for="password">Nama Lapngan</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col s12">
