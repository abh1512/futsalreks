                  ...
                  <tr>
                    <?php
                        ...
                        while($r=mliSelect($er)){
                          ...
                          $pemil = mysqli_query($con,"SELECT id_gedung,pemiliks.nama,gedungs.nama,gedungs.alamat,area,jenis_lap,kode_ref FROM `gedungs` JOIN pemiliks on gedungs.id_pemilik=pemiliks.no_ktp");
                          ...
                          <tr>
                            ...
                            <td><input type="hidden" name='status' value="<?php echo $row[4] ?>"><?php echo $row[4] ?></td>
                            <td><input type="hidden" name='status' value="<?php echo $row[5] ?>"><?php echo $row[5] ?></td>
                            <td><input type="hidden" name='status' value="<?php echo $row[6] ?>"><?php echo $row[6] ?></td>
                          </tr>
                        <?php }?>
                  </tr>
                  </tbody>
