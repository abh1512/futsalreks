                      ...
                      $er=mysqli_query($con,"SELECT l.id_lapangan,l.nama,l.jam_lapangan,l.harga
                        ...
                        while($r=mliSelect($er)){
                          ...
                          <tr>
                            ...
                            <td><input type="hidden" name='id_unesa' value="<?=$r->id_lapangan?>"><?=$r->id_lapangan?></td>
                            <td><input type="hidden" name='nama' value="<?=$r->nama?>"><?=$r->nama?></td>
                            <td><input type="hidden" name='prodi' value="<?$jam1?>"><?=$jam1?></td>
                            <td><input type="hidden" name='status' value="<?=$jam2?>"><?=$jam2?></td>
                            <td><input type="hidden" name='status' value="<?=$r->harga?>"><?=$r->harga?></td>
