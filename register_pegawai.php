  ...
  <body style="background-color:white;">
    ...
    <div class="container">
          ...
          <div class="row">
            ...
            <form action="#" id="login-form" style="width:50%;" class="register-pegawai">
            <div class="heading">Daftar Pegawai Gedung</div>
            <div class="left">
          	<label for="number">Nomor KTP</label> <br />
              <input type="number" name="no_ktp" id="no_ktp" maxlength="16"/> <br />
              <label for="text">Nama Lengkap</label> <br />
              <input type="text" name="nama" id="nama_pegawai" /> <br />
              <label for="text">Alamat Lengkap</label> <br />
              <input type="text" name="alamat" id="alamat_pegawai" /> <br />
              <label for="text">Kode Referensi</label> <br />
